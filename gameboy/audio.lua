...
function Audio.new(modules)
    ...
    audio.reset = function()
        ...
        audio.tone1.duty_length = 0.75 -- percentage, from 0-1
        ...
        audio.tone2.duty_length = 0.75 -- percentage, from 0-1
    ...
    local wave_patterns = {}
    wave_patterns[0] = 0.125
    wave_patterns[1] = 0.25
    wave_patterns[2] = 0.50
    wave_patterns[3] = 0.75
