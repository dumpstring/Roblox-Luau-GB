...
local function apply(opcodes, opcode_cycles, z80, memory)
    ...
    -- ld r, r
    opcodes[0x40] = function()
        reg.b = reg.b
    end
    opcodes[0x41] = function()
        reg.b = reg.c
    end
    opcodes[0x42] = function()
        reg.b = reg.d
    end
    opcodes[0x43] = function()
        reg.b = reg.e
    end
    opcodes[0x44] = function()
        reg.b = reg.h
    end
    opcodes[0x45] = function()
        reg.b = reg.l
    end
    opcode_cycles[0x46] = 8
    opcodes[0x46] = function()
        reg.b = read_at_hl()
    end
    opcodes[0x47] = function()
        reg.b = reg.a
    end

    opcodes[0x48] = function()
        reg.c = reg.b
    end
    opcodes[0x49] = function()
        reg.c = reg.c
    end
    opcodes[0x4A] = function()
        reg.c = reg.d
    end
    opcodes[0x4B] = function()
        reg.c = reg.e
    end
    opcodes[0x4C] = function()
        reg.c = reg.h
    end
    opcodes[0x4D] = function()
        reg.c = reg.l
    end
    opcode_cycles[0x4E] = 8
    opcodes[0x4E] = function()
        reg.c = read_at_hl()
    end
    opcodes[0x4F] = function()
        reg.c = reg.a
    end

    opcodes[0x50] = function()
        reg.d = reg.b
    end
    opcodes[0x51] = function()
        reg.d = reg.c
    end
    opcodes[0x52] = function()
        reg.d = reg.d
    end
    opcodes[0x53] = function()
        reg.d = reg.e
    end
    opcodes[0x54] = function()
        reg.d = reg.h
    end
    opcodes[0x55] = function()
        reg.d = reg.l
    end
    opcode_cycles[0x56] = 8
    opcodes[0x56] = function()
        reg.d = read_at_hl()
    end
    opcodes[0x57] = function()
        reg.d = reg.a
    end

    opcodes[0x58] = function()
        reg.e = reg.b
    end
    opcodes[0x59] = function()
        reg.e = reg.c
    end
    opcodes[0x5A] = function()
        reg.e = reg.d
    end
    opcodes[0x5B] = function()
        reg.e = reg.e
    end
    opcodes[0x5C] = function()
        reg.e = reg.h
    end
    opcodes[0x5D] = function()
        reg.e = reg.l
    end
    opcode_cycles[0x5E] = 8
    opcodes[0x5E] = function()
        reg.e = read_at_hl()
    end
    opcodes[0x5F] = function()
        reg.e = reg.a
    end

    opcodes[0x60] = function()
        reg.h = reg.b
    end
    opcodes[0x61] = function()
        reg.h = reg.c
    end
    opcodes[0x62] = function()
        reg.h = reg.d
    end
    opcodes[0x63] = function()
        reg.h = reg.e
    end
    opcodes[0x64] = function()
        reg.h = reg.h
    end
    opcodes[0x65] = function()
        reg.h = reg.l
    end
    opcode_cycles[0x66] = 8
    opcodes[0x66] = function()
        reg.h = read_at_hl()
    end
    opcodes[0x67] = function()
        reg.h = reg.a
    end

    opcodes[0x68] = function()
        reg.l = reg.b
    end
    opcodes[0x69] = function()
        reg.l = reg.c
    end
    opcodes[0x6A] = function()
        reg.l = reg.d
    end
    opcodes[0x6B] = function()
        reg.l = reg.e
    end
    opcodes[0x6C] = function()
        reg.l = reg.h
    end
    opcodes[0x6D] = function()
        reg.l = reg.l
    end
    opcode_cycles[0x6E] = 8
    opcodes[0x6E] = function()
        reg.l = read_at_hl()
    end
    opcodes[0x6F] = function()
        reg.l = reg.a
    end

    opcode_cycles[0x70] = 8
    opcodes[0x70] = function()
        set_at_hl(reg.b)
    end

    opcode_cycles[0x71] = 8
    opcodes[0x71] = function()
        set_at_hl(reg.c)
    end

    opcode_cycles[0x72] = 8
    opcodes[0x72] = function()
        set_at_hl(reg.d)
    end

    opcode_cycles[0x73] = 8
    opcodes[0x73] = function()
        set_at_hl(reg.e)
    end
    ...
    opcodes[0x77] = function()
        set_at_hl(reg.a)
    end

    opcodes[0x78] = function()
        reg.a = reg.b
    end
    opcodes[0x79] = function()
        reg.a = reg.c
    end
    opcodes[0x7A] = function()
        reg.a = reg.d
    end
    opcodes[0x7B] = function()
        reg.a = reg.e
    end
    opcodes[0x7C] = function()
        reg.a = reg.h
    end
    opcodes[0x7D] = function()
        reg.a = reg.l
    end
    opcode_cycles[0x7E] = 8
    opcodes[0x7E] = function()
        reg.a = read_at_hl()
    end
    opcodes[0x7F] = function()
        reg.a = reg.a
    end

    -- ld r, n
    opcode_cycles[0x06] = 8
    opcodes[0x06] = function()
        reg.b = read_nn()
    end

    opcode_cycles[0x0E] = 8
    opcodes[0x0E] = function()
        reg.c = read_nn()
    end

    opcode_cycles[0x16] = 8
    opcodes[0x16] = function()
        reg.d = read_nn()
    end

    opcode_cycles[0x1E] = 8
    opcodes[0x1E] = function()
        reg.e = read_nn()
    end

    opcode_cycles[0x26] = 8
    opcodes[0x26] = function()
        reg.h = read_nn()
    end

    opcode_cycles[0x2E] = 8
    opcodes[0x2E] = function()
        reg.l = read_nn()
    end

    opcode_cycles[0x36] = 12
    opcodes[0x36] = function()
        set_at_hl(read_nn())
    end

    opcode_cycles[0x3E] = 8
    opcodes[0x3E] = function()
        reg.a = read_nn()
    end
